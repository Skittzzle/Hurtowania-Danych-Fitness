...
class ETLService:
    def __init__(self, db: Session):
        self.db = db
        self.fake = Faker('en_US')  # Angielski
    ...
    def _generate_zajecia(self, count: int) -> List[int]:
        ...
        poziomy = ['Beginner', 'Intermediate', 'Advanced']  # BEZ POLSKICH ZNAKOW
